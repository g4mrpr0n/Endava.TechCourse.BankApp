...
{
    public class TransferFundsHandler : IRequestHandler<TransferFundsCommand, CommandStatus>
    {
        private readonly ApplicationDbContext context;

        public TransferFundsHandler(ApplicationDbContext context)
        {
        ...
        public async Task<CommandStatus> Handle(TransferFundsCommand request, CancellationToken cancellationToken)
        {
